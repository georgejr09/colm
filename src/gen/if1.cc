...
::NI opt_ni::Ni() { static int a[] = {1, 0, 1}; return ::NI( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::STAR opt_prod_repeat::Star() { static int a[] = {1, 0, 0}; return ::STAR( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::LEFT_STAR opt_prod_repeat::LeftStar() { static int a[] = {1, 1, 0}; return ::LEFT_STAR( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
::id prod_var_def::Name() { static int a[] = {1, 0, 0}; return ::id( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::id prod_var_def::Type() { static int a[] = {1, 0, 2}; return ::id( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::prod_var_list prod_var_list::VarDefList() { static int a[] = {1, 0, 0}; return ::prod_var_list( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::prod_var_def prod_var_list::VarDef() { static int a[] = {1, 0, 1}; return ::prod_var_def( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
::prod_var_list item::ProdVarList() { static int a[] = {1, 1, 2}; return ::prod_var_list( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::prod_list item::ProdList() { static int a[] = {1, 1, 3}; return ::prod_list( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::_lrepeat_item start::ItemList() { static int a[] = {1, 0, 0}; return ::_lrepeat_item( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
::NI _T_opt_ni::Ni() { static int a[] = {1, 0, 1}; return ::NI( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::STAR _T_opt_prod_repeat::Star() { static int a[] = {1, 0, 0}; return ::STAR( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::LEFT_STAR _T_opt_prod_repeat::LeftStar() { static int a[] = {1, 1, 0}; return ::LEFT_STAR( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
::id _T_prod_var_def::Name() { static int a[] = {1, 0, 0}; return ::id( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::id _T_prod_var_def::Type() { static int a[] = {1, 0, 2}; return ::id( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::prod_var_list _T_prod_var_list::VarDefList() { static int a[] = {1, 0, 0}; return ::prod_var_list( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::prod_var_def _T_prod_var_list::VarDef() { static int a[] = {1, 0, 1}; return ::prod_var_def( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
::prod_var_list _T_item::ProdVarList() { static int a[] = {1, 1, 2}; return ::prod_var_list( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::prod_list _T_item::ProdList() { static int a[] = {1, 1, 3}; return ::prod_list( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::_lrepeat_item _T_start::ItemList() { static int a[] = {1, 0, 0}; return ::_lrepeat_item( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
